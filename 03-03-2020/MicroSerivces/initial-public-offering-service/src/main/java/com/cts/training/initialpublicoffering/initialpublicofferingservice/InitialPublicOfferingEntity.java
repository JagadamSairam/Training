...
@Table(name = "ipos")
public class InitialPublicOfferingEntity {
 ...
 private LocalDateTime openDateTime;
	private String remarks;
	 ...
	 public InitialPublicOfferingEntity() {

	}

	public InitialPublicOfferingEntity(int id, String companyName, String stockExchange, long pricePerShare, long totalStocks,
